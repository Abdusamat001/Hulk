...
public class PracticeFormPageDate extends BasePage{

    @FindBy(className = "react-datepicker__input-container")
    public WebElement datePickerBtn;

    public PracticeFormPageDate selectDateMonthYear(String dateMonthYear){
        ...
        WebDriverWait wait = new WebDriverWait(DriverManeger.getDriver(), Duration.ofSeconds(10));
