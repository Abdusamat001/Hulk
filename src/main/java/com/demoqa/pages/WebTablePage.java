...
public class WebTablePage extends BasePage{
    ...
    public WebTablePage stemp(List<WebElement> elements){
        WebDriverWait wait = new WebDriverWait(DriverManeger.getDriver(), Duration.ofSeconds(15));
    ...
    public ArrayList<Employee> getEmployeeFromTable(){
        List<WebElement> rows = DriverManeger.getDriver().findElements(By.cssSelector(".ReactTable .rt-tr-group"));
